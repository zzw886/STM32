...
#define MPU6050_IIC_SCL_Pin                GPIO_Pin_9	         //PB10
#define MPU6050_IIC_SDA_Pin                GPIO_Pin_8	         //PB11

#define	MPU6050_IIC_SCL                    PBout(9)
#define	MPU6050_IIC_SDA                    PBout(8)  
#define	MPU6050_IIC_SDA_IN                 PBin(8)              //读数据端口
